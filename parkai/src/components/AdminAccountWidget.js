...
export default class AdminAccountWidget extends React.Component{
    constructor(props){
        super(props)
    }
        ...
        return(
            ...
            {this.state.editing?
                ...
                <form id="edit-details-form">
                    ...
                    <label>Carparks: <a href="http://localhost:2000/admin/dashboard/carparks">View Carparks</a></label>
                    <label>Account Balance: {this.state.user?this.state.user.accountBalance:" "}</label>
                </form>
                <button onClick={
                    async()=>{this.setState(
                        {editing:false}
            ...
            <div className="details">
                <h2>Your Account</h2>
                    ...
                    <p>Password: **********</p>
                    <p>Carparks: <a href="http://localhost:2000/admin/dashboard/carparks">View Carparks</a></p>
                    <p>Account Balance: {this.state.user?this.state.user.accountBalance:" "}</p>
